...
<body class="container">
	...
	<section>
				...
				<div class="col s5">
					<div class="span-1">
						...
						<div class="leftColumn">
							<h5><b>Material:</b></h5>
							<h6>Solid Mahogany, Long Tenon, Hide Glue Fit, 14 Degree Peghead Angle</h6>
							<h5><b>Neck profile:</b></h5>
							<h6>Medium-Chunky C-Shape, scanned from original.</h6>
						...
						<div class="rightColumn">
							<h5><b>Frets:</b></h5>
							<h6>Historic Medium-Jumbo</h6>
							<h5><b>Nut material:</b></h5>
							<h6> Nylon </h6>
							<h5><b>Nut Width: </b></h5>
							<h6>1.687", 42.85mm</h6>
			...
			<div class="row">
				...
				<div class="col s7">
					<img src="./productos/gibson-1/imagen-3.jpg">
				</div>
			</div>
			<div class="row">
				<div class="col s7">
					<img src="./productos/gibson-1/imagen-4.jpg">
				</div>
				<div class="col s5">
					<div class="span-1">
						<h3> Hardware </h3>
						<div class="leftColumn">
							...
							<h6>Gold</h6>
							<h5><b>Bridge:</b></h5>
							<h6>ABR-1 Tune-o-matic w/ Nylon Saddles</h6>
							<h5><b>Tailpiece:</b></h5>
							<h6>Lightweight Aluminum Stopba</h6>
							<h5><b>Tuning Machines:</b></h5>
							<h6>Kluson Waffleback</h6>
							<h5><b>Pick Guard </b></h5>
							<h6> Replica Multi-ply Acrylic</h6>
						</div>
						<div class="rightColumn">
							<h5><b>Control Knobs:</b></h5>
							<h6>Black Witch Hats w/ Gold Reflectors</h6>
							<h5><b>Switch Tip:</b></h5>
							<h6> Cream </h6>
							<h5><b>Switch Washer:</b></h5>
							<h6>Molded Black</h6>
							<h5><b>Jack Plate Cover:</b></h5>
							<h6>Replica Multi-ply Acrylic</h6>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col s5">
					<div class="span-1">
						<h3>Electronics</h3>
						<h5><b>Neck Pickup:</b></h5>
						<h6>68 Custom Humbucker</h6>
						<h5><b>Bridge Pickup:</b></h5>
						<h6>68 Custom Humbucker</h6>
						<h5><b> Controls </b></h5>
						<h6> 2 500K CTS Volume Pots, 2 500K CTS Tone Pots, Hand-Wired Harness with Black Beauty Capacitors, Switchcraft Toggle Switch </h6>
					</div>
				</div>
				<div class="col s7">
					<img src="./productos/gibson-1/imagen-5.jpg">
				</div>
			</div>
			...
			<div>
				...
				<h5><b> Strings </b></h5>
				<h6> 10-13-17-26-36-46 </h6>
				<h5><b> Case </b></h5>
				<h6> Gibson Custom Black Hardshell Case with Gold Lining </h6>
				<h5><b> Other </b></h5>
				<h6> 50th Anniversary Switch Plate Medallion (w/ Extra Black Plastic Cover in the Case), Replica 1968 Gibson Gazette, Exclusive 1968-style Gibson Guitar Picks, Gibson Custom Shop Certificate of Authenticity </h6>
			</div>
	</section>
	<br>
	<section>
			<div class="row">
				...
				<div class="col s4">
					<a href="./productos/archivos/gibson-1.pdf" target="_blank"><img src="./imagenes/download.jpg" width="50%"></a>
				</div>
				<div class="col s4">
				</div>
