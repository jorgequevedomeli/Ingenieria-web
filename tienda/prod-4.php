    ...
    <body class="container">
        ...
        <section>
            ...
            <div class="row">
                ...
                <div class="col s5">
                    <div class="fuente"><b><div class="text-center">Les Paul Classic 2019</div></b></div>
                    <div class="grey-text #e6e6e6"><h5><div class="text-center">Classic 60'S Les Paul Vibes</div></h5></div>
                    <p>
                        The new 2019 Gibson Les Paul Classic boasts a traditional tone wood construction of a mahogany back and 
                        maple top coupled with a mahogany neck and bound rosewood fingerboard. A slim taper neck profile and 61 
                        R and 61 T zebra pickups provide the playability and classic Gibson tones from the era, 4 push-pull control 
                        assembly give a sonic variety to this complete guitar package.
                    </p>
                    <form action="" method="POST">
                        ...
                        <h5 class="text-center">
                            <b>
                               <h6>$2,299.00<h6>
                               <input type="hidden" name="price" value="2299.00">
                               <input type="hidden" name="image" value="guitar4.png">
                               <input type="hidden" name="product" value="Les Paul Classic 2019">
        ...
        <section class="texto-especif">
            <h4>
                Les Paul Classic 2019 Specifications
            </h4>
            <h5>
