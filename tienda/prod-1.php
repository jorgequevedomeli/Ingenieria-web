...
<html>
    ...
    <head>
        <title>Les Paul Junior Trubute DC</title>
    ...
    <body class="container">
        ...
        <section>
            ...
            <div class="row">
                ...
                <div class="col s5">
                    <div class="fuente"><b><div class="text-center">Les Paul Junior Tribute DC 2019</div></b></div>
                    <div class="grey-text #e6e6e6"><h5><div class="text-center">A Junior In Name Only</div></h5></div>
                    <p>
                            The Gibson Les Paul Junior was first introduced as an affordable option for students and beginners, 
                            something we continue in 2019. The new Gibson Les Paul Junior Double Cut boasts true vintage styling 
                            with a mahogany body and maple neck finished in a gorgeous Satin Cherry finish. The pickup and controls a
                            re mounted in an all new pickguard design; a new take on a traditional design. Rosewood fingerboard, 
                            lightening bar tailpiece and P-90 pickup for classic tone and performance finish the package beautifully.
                    </p>
                    <form action="" method="POST" name="formulario" id="formulario">
                        ...
                        <h5 class="text-center">
                            <b>
                               ...
                               <input type="hidden" name="image" value="guitar1.png">
        ...
        <section class="texto-especif">
            <h4>
                    Les Paul Junior Tribute DC 2019 Specifications
            </h4>
            <h5>
