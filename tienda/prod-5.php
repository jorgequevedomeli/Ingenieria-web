...
<html>
    ...
    <head>
        <title>Les Paul Traditional 2019</title>
    ...
    <body class="container">
        ...
        <section>
            ...
            <div class="row">
                ...
                <div class="col s5">
                    <div class="fuente"><b><div class="text-center">Les Paul Traditional 2019</div></b></div>
                    <div class="grey-text #e6e6e6"><h5><div class="text-center">Traditional By Name - Traditional In Nature</div></h5></div>
                    <p>
                        For 2019 the New Gibson Les Paul Traditional is available in 2 gorgeous finishes; Heritage Cherry Sunburst and Tobacco 
                        Burst. Based on the Les Paul guitar that established the legend, with the power, look, and feel of the world's most desirable
                         dual-humbucker electric guitar. The Les Paul Traditional retains the archetypal feel of the vintage Les Paul guitars in its 
                         rounded neck profile, solid rosewood fingerboard and non-weight relieved body. Traditional looks are complemented by the legendary 
                         tonewood combination of a mahogany body and AA figured maple top, Vintage Keystone tuners, ABR-1 Tune-o-matic bridge and 
                         nickel-plated hardware. Classic PAF tones are enhanced by hand-wired electronics including Orange Drop capacitors.
                    </p>
                    <form action="" method="POST">
                        ...
                        <label>
                            <input type="radio" name="guitar-orientation" value="Right-Handed" checked="checked">
                            <span>Righty</span>
                        </label>
                        <h5 class="text-center">
                            <b>
                               <h6>$2,799.00<h6>
                               <input type="hidden" name="price" value="2799.00">
                               <input type="hidden" name="image" value="guitar5.png">
                               <input type="hidden" name="product" value="Les Paul Traditional 2019">
                        ...
                        <div class="col s6">
                            <span class="text-center">
                                    <div class="blue-text text-darken-2">
                                        <input type="submit" name="buy" value="buy" class = "blue-text text-darken-2 waves-effect waves-marron btn-large btn-group boton" onclick=this.form.action="compra.php">
                                    </div>
                            </span>
                        </div>
                        <div class="col s6">
                                <span class="text-center">
                                        <div class="blue-text text-darken-2">
                                            <input type="submit" name="cart" value="add to cart" class = "blue-text text-darken-2 waves-effect waves-marron btn-large btn-group boton" onclick=this.form.action="carrito.php">
                                        </div>
                                </span>
                        </div>
                    </form>
        ...
        <section class="texto-especif">
            <h4>
                    Les Paul Traditional 2019 Specifications
            </h4>
            <h5>
