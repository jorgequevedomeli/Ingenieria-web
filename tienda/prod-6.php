...
<html>
    ...
    <head>
        <title>Les Paul Standard 2019</title>
    ...
    <body class="container">
        ...
        <section>
            ...
            <div class="row">
                ...
                <div class="col s5">
                    <div class="fuente"><b><div class="text-center">Les Paul Standard 2019</div></b></div>
                    <div class="grey-text #e6e6e6"><h5><div class="text-center">Les Is More</div></h5></div>
                    <p>
                        The iconic Les Paul Standard is celebrated by the world’s greatest musicians as the standard for 
                        perfection in the world of electric guitars. The new 2019 Les Paul Standard features the popular 
                        asymmetrical Slim Taper neck profile with Ultra-Modern weight relief for increased comfort and playability.
                         Impeccable looks are highlighted by the powerful tonewood combination of mahogany back and carved maple AAA f
                         igured top. Calibrated BurstBucker Pro humbuckers provide modern and classic tones, while immense tonal variety 
                         comes from 4 push-pull knobs and an internal 5 position DIP switch for a multitude of tonal variations.
                    </p>
                    <form action="" method="POST">
                        ...
                        <h5 class="text-center">
                            <b>
                               <h6>$3,399.00<h6>
                               <input type="hidden" name="price" value="3399.00">
                               <input type="hidden" name="image" value="guitar6.png">
                               <input type="hidden" name="product" value="Les Paul Junior Tribute DC 2019">
        ...
        <section class="texto-especif">
            <h4>
                Les Paul Standard 2019 Specifications
            </h4>
            <h5>
