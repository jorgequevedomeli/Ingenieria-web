...
<html>
    ...
    <head>
        <title>Les Paul Studio 2019</title>
    ...
    <body class="container">
        ...
        <section>
            ...
            <div class="row">
                ...
                <div class="col s5">
                    <div class="fuente"><b><div class="text-center">Les Paul Studio 2019</div></b></div>
                    <div class="grey-text #e6e6e6"><h5><div class="text-center">Studio And Stage Ready</div></h5></div>
                    <p>
                    The Les Paul Studio embodies the essential Les Paul features with enhancements for playability and 
                    tonal versatility. The white-bound rosewood fingerboard and slim-taper mahogany neck provide 
                    effortless playability and comfort. The 490R and 498T pickups provide tight, high output humbucking
                     performance and the two push-pull pots offer additional coil-tapping options. Available in two all
                      new delicious colors: Tangerine Burst and BBQ Burst.
                    </p>
                    <form action="" method="POST">
                        ...
                        <h5 class="text-center">
                            <b>
                               ...
                               <input type="hidden" name="image" value="guitar2.png">
                               <input type="hidden" name="product" value="Les Paul Studio 2019">
        ...
        <section class="texto-especif">
            <h4>
                Les Paul Studio 2019 Specifications
            </h4>
            <h5>
